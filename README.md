...
MoDiSc (Modeling Disks in Scattered light) is a python package to model debris disks in scattered light. It was first used to constrain the morphology and the photometry of the debris disk HD 120326 (HIP 67497) imaged in total and polarized intensity with VLT/SPHERE data  in Desgrange et al. (2025).
